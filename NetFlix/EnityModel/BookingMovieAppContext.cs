...
public partial class BookingMovieAppContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer("Data Source=localhost,1433; Initial Catalog=BookingMovieApp; TrustServerCertificate=True; User Id=admin1; Password=123", builder =>
